...
public class CreateAccountSD {
    ...
    MyAccountPage myAccPage = new MyAccountPage();
        ...
        @And("^User entered (.+), (.+), (.+), (.+), (.+) on Create Teacher Account screen$")
        ...
        @And("^User searched for school by '(.+)', '(.+)' on My School screen$")
        ...
        @And("^User searched for school by '(.+)', '(.+)' and (.+) on My School screen$")
        ...
        @And("^User Selected Role: '(.+)', Grade: '(.+)', (.+) student on My Role screen$")
        ...
        public void isNameSame() {
            ...
            System.out.println(tempDataHolder1);
        ...
        public void isAddressSame() {
            ...
            System.out.println(tempDataHolder2);
