...
Feature: Add Student Flyer Order
  ...
  Scenario Outline: Teacher can add multiple books for a student in SFO (Student Flyer Order)
    ...
    Then User verified correct student name, item number and quantity gets added under SFO <studentName>, <item1>, <qty1>, <item2>, <qty2>, <item3>, <qty3>
    Then User verified correct Student-total (amount, items and quantity) and SFO Total <item1>, <qty1>, <item2>, <qty2>, <item3>, <qty3>
  ...
  Scenario Outline: Teacher can add multiple books for a students in SFO (Student Flyer Order)
    ...
    Then User verified correct students names, item numbers and quantity gets added under SFO <studentName1>, <item1>, <qty1>, <item2>, <qty2>, <studentName2>, <item3>, <qty3>, <studentName3>, <item4>, <qty4>, <item5>, <qty5>
    Then User verified correct Students-total (amount, items and quantity) for every student and SFO Total <studentName1>, <item1>, <qty1>, <item2>, <qty2>, <studentName2>, <item3>, <qty3>, <studentName3>, <item4>, <qty4>, <item5>, <qty5>
    Examples:
...
#  Verify:
#  Thank you message.
#  Order receipt reference number is displayed.
#
#  Verify user can place an order by adding a new credit card
